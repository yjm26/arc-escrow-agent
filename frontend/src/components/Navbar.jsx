  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-10 py-4 bg-[#faf9f7]/95 dark:bg-[#0c0f1a]/95 backdrop-blur-xl border-b border-stripe-border dark:border-white/10">
      ...
      <div className="hidden md:flex items-center gap-7">
        ...
        <div className="flex items-center gap-3 ml-4 pl-4 border-l border-stripe-border dark:border-white/10">
          <ThemeToggle />
          ...
          {wallet ? (
            <>
              ...
              <div className="relative">
                <button onClick={() => setShowWalletMenu(!showWalletMenu)} className="flex items-center gap-2 px-3 py-2 bg-stripe-surface dark:bg-white/5 border border-stripe-border dark:border-white/10 rounded-md text-[13px] font-mono hover:border-stripe-navy dark:hover:border-white/20 transition">
